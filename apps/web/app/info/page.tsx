  ...
  return (
    <div className="relative flex flex-col w-full max-w-screen-2xl mx-auto px-6 py-4 md:px-8 gap-3 min-h-screen">
      <div className="sticky top-0 left-0 right-0 py-2 flex flex-row items-center z-50 rounded-xl bg-light-100/30 dark:bg-dark-900/30 -mx-2 px-2 backdrop-blur-xl">
        ...
        <p className="font-semibold text-xl">Disclown</p>
      ...
      <div className="z-[2] -mt-[100px] mb-[50px] grid grid-cols-1 lg:grid-cols-2 gap-6 text-accent-50">
        <div className="bg-gradient-to-br from-black via-black to-orange-900 px-7 py-6 rounded-xl flex flex-col gap-3">
          <h2 className="font-bold text-2xl">Super rapide</h2>
          <p className="text-accent-600">
            En utilisant Redis, PlanetScale avec Drizzle ORM pour fournir une
            vitesse de chargement incroyable
          </p>
          <div className="flex flex-row gap-3 mt-auto">
            <Link
              href="https://github.com/AbsolumFrAG/disclown#disclown"
              target="_blank"
            >
      ...
      <p className="text-accent-900 dark:text-accent-50 mx-auto text-sm">
        Made with ❤️ by Lou Tigroudja, Alex Caetano, Neil Roche.
      </p>
    </div>
  );
}
  ...
  return (
    <div className="relative z-[2] mt-20">
      ...
      <p className="mt-3 text-base md:text-lg text-muted-foreground">
        Disclown est une application de chat open source construite avec Next.js
        et Tailwind CSS
      </p>
  ...
  return (
    <div className="z-[2] w-full xl:w-[50%] mt-10 lg:mt-28 grid grid-cols-1 md:grid-cols-2 gap-3">
      <div className="bg-white dark:bg-dark-800 rounded-xl shadow-2xl p-4">
        <p className="text-lg font-semibold">Groupe de discussion</p>
        <p className="text-base text-accent-800 dark:text-accent-600 mt-2">
          Interagissez avec d&apos;autres personnes de votre groupe
        </p>
      </div>
      <div className="bg-white dark:bg-dark-800 rounded-xl shadow-2xl p-4">
        <p className="text-lg font-semibold">Message direct</p>
        <p className="text-base text-accent-800 dark:text-accent-600 mt-2">
          Parlez avec votre ami directement et en privé
        </p>
      </div>
    </div>
  );
  ...
  return (
    <>
      ...
      >
        {[
          {
            name: "Personnaliser le profil et le groupe de discussion",
            description:
              "Créez votre propre profil personnalisé et vos informations de groupe en un seul clic",
            icon: (
              <PaintbrushIcon className="text-brand w-14 h-14 p-2 bg-light-100 dark:bg-dark-900 rounded-xl" />
            ),
          },
          {
            name: "Invitations de groupe",
            description:
              "Invitez facilement des membres du groupe avec une URL courte ou un code d'invitation",
            icon: (
              <MailIcon className="text-brand w-14 h-14 p-2 bg-light-100 dark:bg-dark-900 rounded-xl" />
            ),
          },
          {
            name: "Envoyer des images et des vidéos",
            description:
              "Partagez des souvenirs et des photos avec vos amis de n'importe où",
            icon: (
